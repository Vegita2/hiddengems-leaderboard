...
- `types/`: TypeScript schemas that document the data shape for the JSON files and API responses.

## Build, Test, and Development Commands

- `python -m http.server 4200` — serve this folder so `fetch` succeeds; open `http://localhost:4200/`.
